...
ccc_codes::ccc_codes(int v) 
{
  ...
  if (version == 9) {
    ...
    {
      // diagnostic codes
      "3180","3181","3182","330","33111","33119","3314","33189","3319","3320","3321",
      ...
      // procedure codes
      "0152","0153","0221","0222","0231","0232","0233","0234","0235","0239","0241",
    ...
    {
      // diagnostic codes
      "4161","4168","4169","4240","4258","4242","4243","4250","4251","4252","4253",
      ...
      "V533",
      // procedure codes 
      "0050","0051","0053","0054","0055","0057","1751","1752","3581","3582","3583",
    ...
    codes_respiratory =
    {
      ...
      // procedure codes
      "303","304","3121","3129","3141","3174","3241","3249","3250","3259","3321",
    ...
    codes_renal =
    {
      ...
      // procedure codes
      "3895","3927","3942","3993","3994","3995","5498","5502","5503","5504","5512",
    ...
    {
      // diagnostic codes
      "4530","5364","555","556","5571","5602","5647","5714","5715","5716","5717",
      "5718","5719","7503","751","V427","V4283","V4284","V441","V442","V443","V444","V5350",
      "V5351","V5359","V551","V552","V553","V554",
      // procedure codes
      "253","254","4210","4211","4242","4281","4311","4319","4391","4399","4412",
    ...
    codes_hemato_immu =
    {
      ...
      // procedure codes
      "4100","4101","4102","4103","4104","4105","4106","4107","4108","4109","415", "4194"
    };
    ...
    codes_metabolic =
    {
      ...
      "V4585","V5391","V6546",
      // procedure codes
      "064","0652","0681","073","0764","0765","0768","0769","624","6241","645","6551",
      "6553","6561","6563","6841","6849","6851","6859","6861","6869","6871","6879","8606"
    };

    codes_congeni_genetic =
    {
      // diagnostic codes
    ...
    {
      // diagnostic codes
      "5190","5364","9960","9961","9962","9964","99661","99662","99663","99666","99667",
    ...
    {
      // diagnostic codes
      "99680","99681","99682","99683","99684","99685","99686","99687","99688","99689",
      "V421","V422","V426","V427","V4281","V4282","V4283","V4284","V432","V4585","V5391",
      // procedure codes
      "3751","3350","3351","3352","336", "5561","5569","4697","5051","5059","5280","5282",
    ...
    {
      // diagnostic codes
      "E750","E751","E752","E754","F71","F72","F73","F842","G111","G112","G114","G118",
    ...
    {
      // diagnostic codes 
      "I270","I271","I272","I2781","I2789","I279","I340","I348","I360","I368","I370",
    ...
    {
      // diagnostic codes
      "E84","G4753","I2782","I43","Q30","Q31","Q32","Q33","Q34","P280","Z902","J84112",
    ...
    {
      // diagnostic codes
      "N18","Q60","Q61","Q62","Q63","Q64","Z905","Z906","G834","N312","N319","T8571XA",
    ...
    {
      // diagnostic codes
      "K50","K51","K73","K74","K754","K760","K761","K762","K763","K768","Q390","Q391",
    ...
    {
      // diagnostic codes
      "D841","E700","E702","E703","E704","E705","E708","E710","E711","E712","E713", 
    ...
    {
      // diagnostic codes
      "E343","K449","M410","M412","M4130","M418","M419","M4330","M965","Q722","Q750",
    ...
    {
      // diagnostic codes
      "C","D00","D01","D02","D03","D04","D05","D06","D07","D08","D09","D37","D38",
    ...
    {
      // diagnostic codes
      "P0501","P0511","P0502","P0512","P052","P059","P0701","P0702","P0721","P0722",
    ...
    {
      //diagnostic codes
      "T8509XA","T85190A","T85192A","T85199A","T8579XA","Z982","Z45441","Z45442","T82519A",
    ...
    {
      // diagnostic codes
      "T8600","T8601","T8602","T8609","T8610","T8611","T8612","T8620","T8621","T8622",
...
int ccc_codes::neuromusc(std::vector<std::string>& x) {
  int xitr, itr; 

  for (xitr = 0; xitr < x.size(); ++xitr) { 
    for (itr = 0; itr < codes_neuromusc.size(); ++itr) {
      if (x[xitr].compare(codes_neuromusc[itr]) == 0) {
        return 1;
      }
    } 
  } 
...
int ccc_codes::cvd(std::vector<std::string>& x) {
  int xitr, itr; 

  for (xitr = 0; xitr < x.size(); ++xitr) { 
    for (itr = 0; itr < codes_cvd.size(); ++itr) {
      if (x[xitr].compare(codes_cvd[itr]) == 0) {
        return 1;
      }
    } 
  } 
...
int ccc_codes::respiratory(std::vector<std::string>& x) {
  int xitr, itr; 

  for (xitr = 0; xitr < x.size(); ++xitr) { 
    for (itr = 0; itr < codes_respiratory.size(); ++itr) {
      if (x[xitr].compare(codes_respiratory[itr]) == 0) {
        return 1;
      }
    } 
  } 
...
int ccc_codes::renal(std::vector<std::string>& x) {
  int xitr, itr; 

  for (xitr = 0; xitr < x.size(); ++xitr) { 
    for (itr = 0; itr < codes_renal.size(); ++itr) {
      if (x[xitr].compare(codes_renal[itr]) == 0) {
        return 1;
      }
    } 
  } 
...
int ccc_codes::gi(std::vector<std::string>& x) {
  int xitr, itr; 

  for (xitr = 0; xitr < x.size(); ++xitr) { 
    for (itr = 0; itr < codes_gi.size(); ++itr) {
      if (x[xitr].compare(codes_gi[itr]) == 0) {
        return 1;
      }
    } 
  } 
...
int ccc_codes::hemato_immu(std::vector<std::string>& x) {
  int xitr, itr; 

  for (xitr = 0; xitr < x.size(); ++xitr) { 
    for (itr = 0; itr < codes_hemato_immu.size(); ++itr) {
      if (x[xitr].compare(codes_hemato_immu[itr]) == 0) {
        return 1;
      }
    } 
  } 
...
int ccc_codes::metabolic(std::vector<std::string>& x) {
  int xitr, itr; 

  for (xitr = 0; xitr < x.size(); ++xitr) { 
    for (itr = 0; itr < codes_metabolic.size(); ++itr) {
      if (x[xitr].compare(codes_metabolic[itr]) == 0) {
        return 1;
      }
    } 
  } 
...
int ccc_codes::congeni_genetic(std::vector<std::string>& x) {
  int xitr, itr; 

  for (xitr = 0; xitr < x.size(); ++xitr) { 
    for (itr = 0; itr < codes_congeni_genetic.size(); ++itr) {
      if (x[xitr].compare(codes_congeni_genetic[itr]) == 0) {
        return 1;
      }
    } 
  } 
...
int ccc_codes::malignancy(std::vector<std::string>& x) {
  int xitr, itr; 

  for (xitr = 0; xitr < x.size(); ++xitr) { 
    for (itr = 0; itr < codes_malignancy.size(); ++itr) {
      if (x[xitr].compare(codes_malignancy[itr]) == 0) {
        return 1;
      }
    } 
  } 
...
int ccc_codes::neonatal(std::vector<std::string>& x) {
  int xitr, itr; 

  for (xitr = 0; xitr < x.size(); ++xitr) { 
    for (itr = 0; itr < codes_neonatal.size(); ++itr) {
      if (x[xitr].compare(codes_neonatal[itr]) == 0) {
        return 1;
      }
    } 
  } 
...
int ccc_codes::tech_dep(std::vector<std::string>& x) {
  int xitr, itr; 

  for (xitr = 0; xitr < x.size(); ++xitr) { 
    for (itr = 0; itr < codes_tech_dep.size(); ++itr) {
      if (x[xitr].compare(codes_tech_dep[itr]) == 0) {
        return 1;
      }
    } 
  } 
...
int ccc_codes::transplant(std::vector<std::string>& x) {
  int xitr, itr; 

  for (xitr = 0; xitr < x.size(); ++xitr) { 
    for (itr = 0; itr < codes_transplant.size(); ++itr) {
      if (x[xitr].compare(codes_transplant[itr]) == 0) {
        return 1;
      }
    } 
  } 
