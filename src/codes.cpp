...
struct icd09_dx_codes { 
  std::vector<std::string> neuromusc =
  ...
  std::vector<std::string> hemato_immu =
  ...
  std::vector<std::string> tech_dep =
...
struct icd09_pc_codes {
  ...
  std::vector<std::string> hemato_immu =
  {"4100","4101","4102","4103","4104","4105","4106","4107","4108","4109","415", 
    "4194"};
...
Rcpp::List dx_codes(int version) { 
  if (version == 9) { 
    ...
    return Rcpp::List::create(
        Rcpp::Named("neuromusc")       = Rcpp::wrap(cds.neuromusc),
        Rcpp::Named("cvd")             = Rcpp::wrap(cds.cvd),
        Rcpp::Named("respiratory")     = Rcpp::wrap(cds.respiratory),
        Rcpp::Named("renal")           = Rcpp::wrap(cds.renal),
        Rcpp::Named("gi")              = Rcpp::wrap(cds.gi),
        Rcpp::Named("hemato_immu")     = Rcpp::wrap(cds.hemato_immu),
        Rcpp::Named("metabolic")       = Rcpp::wrap(cds.metabolic),
        Rcpp::Named("congeni_genetic") = Rcpp::wrap(cds.congeni_genetic),
        Rcpp::Named("malignancy")      = Rcpp::wrap(cds.malignancy),
        Rcpp::Named("neonatal")        = Rcpp::wrap(cds.neonatal),
        Rcpp::Named("tech_dep")        = Rcpp::wrap(cds.tech_dep),
        Rcpp::Named("transplant")      = Rcpp::wrap(cds.transplant));
  } else if (version == 10) {
    icd10_dx_codes cds;
    return Rcpp::List::create(
        Rcpp::Named("neuromusc")       = Rcpp::wrap(cds.neuromusc),
    ...
    ::Rf_error("version 9 or 10 please.");
  } 
}
...
Rcpp::List pc_codes(int version) { 
  if (version == 9) { 
    ...
    return Rcpp::List::create(
        ...
        Rcpp::Named("hemato_immu")     = Rcpp::wrap(cds.hemato_immu),
        Rcpp::Named("metabolic")       = Rcpp::wrap(cds.metabolic),
        Rcpp::Named("congeni_genetic") = NA_STRING,
        Rcpp::Named("malignancy")      = Rcpp::wrap(cds.malignancy),
        Rcpp::Named("neonatal")        = NA_STRING,
        Rcpp::Named("tech_dep")        = Rcpp::wrap(cds.tech_dep),
        Rcpp::Named("transplant")      = Rcpp::wrap(cds.transplant));
  } else if (version == 10) {
    icd10_pc_codes cds;
...
Rcpp::StringVector dx_nuromusc(int version) {
 ...
 return Rcpp::wrap(temp.cvd);
 
  if (version == 9) { 
    return Rcpp::wrap(temp.neuromusc);
  } else if (version == 10) {
    return Rcpp::wrap(temp.neuromusc);
  } else {
    ::Rf_error("version 9 or 10 please.");
